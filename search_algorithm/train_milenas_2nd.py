...
parser.add_argument('--optimization', type=str, default='V2', help='Optimization Methods: V2; V2_2ndOrder')
...
def train(epoch, train_queue, valid_queue, model, architect, criterion, optimizer, lr):
    ...
    for step, (input, target) in enumerate(train_queue):
        ...
        # else:
        architect.step_milenas_2ndorder(input, target, input_search, target_search, lr, optimizer,
